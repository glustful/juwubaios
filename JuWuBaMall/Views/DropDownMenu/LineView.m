...
//  QunariPhone
//
//  Created by zhanglan on 12-11-21.
...
- (id)initWithFrame:(CGRect)frameInit
{
	if((self = [super initWithFrame:frameInit]) != nil)
    {
		...
		_arrayColor = [NSArray arrayWithObjects:
					   [UIColor colorWithHex:kDefaultLineColor[0] alpha:1.0f],
					   [UIColor colorWithHex:kDefaultLineColor[1] alpha:1.0f],
					   nil];
...
- (id)initDottedWithFrame:(CGRect)frameInit
{
	if((self = [super initWithFrame:frameInit]) != nil)
    {
		...
		_isDotted = YES;
		_arrayColor = [NSArray arrayWithObjects:
					   [UIColor colorWithHex:kDefaultDottedLineColor[0] alpha:1.0f],
					   [UIColor colorWithHex:kDefaultDottedLineColor[1] alpha:1.0f],
					   nil];
