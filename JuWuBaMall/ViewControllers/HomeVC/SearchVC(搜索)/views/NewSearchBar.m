...
- (instancetype)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        ...
        self.backgroundColor = [UIColor colorWithRed:223/255.f green:90/255.f  blue:56/255.f  alpha:1];
        
        
        //圆角白色背景框
        self.mb_searchBackView = [[UIImageView alloc]initWithFrame:CGRectMake(10, 25, frame.size.width-10-50, frame.size.height-20-15)];
        ...
        self.mb_searchQuitButton.frame = CGRectMake(frame.size.width-50,15, 50, 50);
