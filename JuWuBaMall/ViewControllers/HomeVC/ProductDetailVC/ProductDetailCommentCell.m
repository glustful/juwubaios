...
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    ...
    static NSString *ID = @"ProductDetailCommentCell";
    
    ProductDetailCommentCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        
        cell = [[ProductDetailCommentCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
...
- (void)customWithModel:(ProductRated *)comment{
    ...
    self.rated_level1.frame = CGRectMake(gap,gap, 20, 20);
    ...
    self.rated_level3.frame = CGRectMake(CGRectGetMaxX(self.rated_level2.frame)+4, gap, 20, 20);
